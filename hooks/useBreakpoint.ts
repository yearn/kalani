/*
 * 
 * ADAPTED FROM https://stackoverflow.com/a/76630444/6543935
 * 
...
import { useRequireClient } from './useRequireClient'
...
export function useBreakpoint<K extends string>(breakpointKey: K) {
    ...
    const breakpoint = useMediaQuery({ query: `(max-width: ${breakpointValue})` })
    ...
    return {
        ...
        [`isAbove${capitalizedKey}`]: !breakpoint,
        [`isBelow${capitalizedKey}`]: breakpoint,
